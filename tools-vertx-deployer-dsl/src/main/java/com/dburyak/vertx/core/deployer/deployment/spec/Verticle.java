...
public abstract class Verticle<IN extends InAction, OUT extends OutAction> {
    private static final VerticleType TYPE_DEFAULT = VerticleType.VERTX_EVENT_BUS;
    ...
    public abstract List<com.dburyak.vertx.core.VerticleProducer<?>> createBySpec(Verticles verticles);
