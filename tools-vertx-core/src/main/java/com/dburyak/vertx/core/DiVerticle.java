 ...
 *
 * <p>This is a base building block for actor-based system that adds important features on top of Vertx
 ...
 *
 * <p>It's already marked as a prototype bean since more than one instance of verticle may be created. Implementations
...
public abstract class DiVerticle extends AbstractVerticle {
     ...
     * Start this verticle.
     *
     * <p>Is not designed to be called directly, rather is called by the {@link VertxDiApp}
     * on startup. Also may be called indirectly via
     * {@link VertxDiApp#deployVerticle(VerticleProducer)}.
     *
        ...
        return Completable
                .fromAction(() -> {
                    ...
                    verticleBeanCtx.registerSingleton(ApplicationContext.class, verticleBeanCtx,
                            byQualifiers(byStereotype(Primary.class), byStereotype(VerticleScope.class)));
     ...
     * Stop this verticle.
     *
     * <p>Is not designed to be called directly, rather is called by the {@link VertxDiApp} on shutdown.
     * Also may be called indirectly via {@link VertxDiApp#undeployVerticle(String)}.
     *
