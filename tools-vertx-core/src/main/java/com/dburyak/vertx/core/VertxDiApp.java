...
public abstract class VertxDiApp {
    ...
    public final Completable start() {
        return Completable
                ...
                .doOnSuccess(appCtx -> this.appCtx = appCtx)
    ...
    public final Completable undeployVerticle(String deploymentId) {
        return Single
                .fromCallable(() -> appCtx.getBean(Vertx.class))
    ...
    private void injectMainBeansIntoVerticleBeanContext(ApplicationContext verticleCtx, ApplicationContext mainCtx) {
        verticleCtx.registerSingleton(ApplicationContext.class, mainCtx, Qualifiers.byStereotype(AppScope.class));
        var vertx = mainCtx.getBean(Vertx.class);
        verticleCtx.registerSingleton(Vertx.class, vertx, Qualifiers.byStereotype(AppScope.class));
    }
}
