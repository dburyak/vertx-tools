...
public class HttpProxyInVerticle extends Verticle<HttpProxyInVerticle.InAction, HttpProxyInVerticle.OutAction> {
    ...
    @EqualsAndHashCode(callSuper = true)
    @SuperBuilder(toBuilder = true)
    public static class OutAction extends com.dburyak.vertx.core.deployer.deployment.spec.OutAction {
        private final String basePath;
    ...
    @EqualsAndHashCode(callSuper = true)
    @SuperBuilder(toBuilder = true)
    public static class InAction extends com.dburyak.vertx.core.deployer.deployment.spec.InAction {
